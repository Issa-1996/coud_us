                        ...
                        <div class="form-step" id="step5">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="tel" class="form-control" id="addTelephone" placeholder="771234567" maxlength="9" pattern="(7[0-9]{8}|33[0-9]{7})" title="Numéro sénégalais: mobile (7X XXX XX XX) ou fixe (33 XXX XX XX)">
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="tel" class="form-control" id="editTelephone" name="editTelephone" placeholder="771234567" maxlength="9" pattern="(7[0-9]{8}|33[0-9]{7})" title="Numéro sénégalais: mobile (7X XXX XX XX) ou fixe (33 XXX XX XX)">
                                            </div>
                                        </div>
                                    </div>
                                </div>
